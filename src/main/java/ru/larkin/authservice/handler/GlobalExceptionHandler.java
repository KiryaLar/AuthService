package ru.larkin.authservice.handler;
...
import ru.larkin.authservice.exception.AuthAppException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAuthAppException(AuthAppException ex) {
